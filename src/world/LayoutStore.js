...
export const PRODUCT_CATALOG = {
  'product-1': {
    name: '复古眼镜', price: '¥1,299', category: '眼镜',
  ...
  'product-2': {
    name: '笔记本电脑', price: '¥8,999', category: '电脑',
  ...
  'product-3': {
    name: '3D 打印机', price: '¥2,599', category: '3D打印',
  ...
  'product-4': {
    name: '3D 建模扫描仪', price: '¥3,499', category: '扫描设备',
  ...
  'product-6': {
    name: '蓝牙音箱', price: '¥1,899', category: '音频',
    desc: '高保真便携蓝牙音箱，澎湃低音。',
    choices: [
  ...
  'product-7': {
    name: '机械手表', price: '¥6,499', category: '腕表',
    desc: '瑞士自动机械腕表，精密机芯。',
    choices: [
  ...
  'product-8': {
    name: '复古相机', price: '¥4,299', category: '摄影',
    desc: '旁轴复古胶片相机，手动对焦。',
    choices: [
...
export class LayoutStore {
  ...
  static defaultLayout() {
    ...
    const side = (i, index) => {
      ...
      const z = -L / 2 + 4 + index * 11; // 每家店间距 11m
